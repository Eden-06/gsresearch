...
WARNING
 This is a test module to include the use of watir to query google scholar.
...
#register module
Modules["gsw"]=lambda do|agent,verbose|
	GSCrawler.new(agent,verbose)
end
Modules["googlescholar-watir"]=lambda do|agent,verbose|
	GSCrawler.new(agent,verbose)
end
